    ...
    <main className="min-h-screen flex items-center justify-center p-6">
      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">비전대 포털 학번/비밀번호로 로그인</p>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-2 rounded-xl bg-indigo-600 text-white py-2.5 font-semibold hover:bg-indigo-500 disabled:opacity-50 transition-colors"
        >
          {loading ? "확인 중..." : "로그인"}
        </button>
